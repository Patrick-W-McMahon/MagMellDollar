...
# TestNode: A peer we use to send messages to magmelldollard, and store responses.
...
class CompactBlocksTest(MagmelldollarTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes magmelldollard to (reasonably!) disconnect us, so do this last.
    ...
    # magmelldollard's choice of nonce.
    ...
    # Test that magmelldollard requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for magmelldollard to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # magmelldollard will not send blocktxn responses for blocks whose height is
