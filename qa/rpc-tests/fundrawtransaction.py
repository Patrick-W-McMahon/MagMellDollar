...
class RawTransactionsTest(MagmelldollarTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid magmelldollar address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid magmelldollar address" in e.error['message'])
