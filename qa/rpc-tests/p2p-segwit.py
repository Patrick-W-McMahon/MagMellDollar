...
class SegWitTest(MagmelldollarTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, magmelldollard delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let magmelldollard fill it in.
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # Magmelldollar: Blocks with nVersion < VB_TOP_BITS are rejected
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older magmelldollard's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-magmelldollard> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active magmelldollard
