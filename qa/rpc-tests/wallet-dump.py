...
from test_framework.util import (start_nodes, start_node, assert_equal, magmelldollard_processes)
...
class WalletDumpTest(MagmelldollarTestFramework):
    ...
    def run_test (self):
        ...
        magmelldollard_processes[0].wait()
