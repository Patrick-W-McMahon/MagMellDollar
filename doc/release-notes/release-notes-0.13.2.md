Magmelldollar Core version 0.13.2 is now available from:
  ...
  <https://magmelldollar.org/bin/magmelldollar-core-0.13.2/>
...
- #8908 `4a974b2` Update magmelldollar-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow magmelldollar-tx to create v2 transactions (btcdrak)
