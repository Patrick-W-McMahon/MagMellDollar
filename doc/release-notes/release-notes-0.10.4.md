Magmelldollar Core version 0.10.4 is now available from:

  <https://magmelldollar.org/bin/magmelldollar-core-0.10.4/>
...
- #6953 `43c2789` Split magmelldollar-tx into its own package
- #6953 `dfe0d4d` Include magmelldollar-tx binary on Debian/Ubuntu
