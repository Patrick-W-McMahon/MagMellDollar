Magmelldollar version 0.5.4 is now available for download at:
http://sourceforge.net/projects/magmelldollar/files/Magmelldollar/magmelldollar-0.5.4/
...
http://gitorious.org/magmelldollar/magmelldollard-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Magmelldollar-Qt notifications under Growl 1.3.
Increase required age of Magmelldollar-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMagmelldollar properly when installing Magmelldollar-Qt over it. (Windows)
