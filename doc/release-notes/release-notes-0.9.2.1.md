Magmelldollar Core version 0.9.2.1 is now available from:

  https://magmelldollar.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MMD to 0.01 MMD
...
- Fix "Start magmelldollar on system login"
