Magmelldollar-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/magmelldollar/files/Magmelldollar/magmelldollar-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Magmelldollar
...
New/changed settings (command-line or magmelldollar.conf file)
--------------------------------------------------------
