...
Then, to tunnel a SSL connection on 29024 to a RPC server bound on localhost on port 19024 do:

    stunnel -d 29024 -r 127.0.0.1:19024 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:9024/
        ProxyPassReverse http://127.0.0.1:9024/
