Magmelldollar Core version 0.9.4 is now available from:

  https://magmelldollar.org/bin/0.9.4/
...
this update is incompatible with the Magmelldollar system and could lead to consensus
forks.

Magmelldollar Core released binaries from https://magmelldollar.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~magmelldollar/+archive/ubuntu/magmelldollar
- A third-party or self-compiled Magmelldollar Core

upgrade to Magmelldollar Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
