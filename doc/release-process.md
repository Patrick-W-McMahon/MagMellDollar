...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/magmelldollar/magmelldollar/blob/master/doc/translation_process.md#synchronising-translations).
...
* Update hardcoded [seeds](/contrib/seeds/README.md), see [this pull request](https://github.com/magmelldollar/magmelldollar/pull/7415) for an example.
...
### Magmelldollar maintainers/release engineers, update version in sources
...
### Fetch and create inputs: (first time, or when dependency versions change)
    ...
    pushd ./gitian-builder
    mkdir -p inputs
    wget -P inputs https://magmelldollarcore.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
### Build and sign Magmelldollar Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit magmelldollar=v${VERSION} ../magmelldollar/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit magmelldollar=v${VERSION} ../magmelldollar/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit magmelldollar=v${VERSION} ../magmelldollar/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`magmelldollar-${VERSION}-osx-unsigned.dmg`, `magmelldollar-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring
    ...
    gpg --import magmelldollar/contrib/gitian-keys/*.pgp
...
space *do not upload these to the magmelldollar.org server, nor put them in the torrent*.
...
- Announce the release:
  ...
  - magmelldollar-dev mailing list

  - Magmelldollar Core announcements list https://groups.google.com/forum/#!forum/magmelldollar-dev

  - blog.magmelldollar.org blog post

  - magmelldollartalk.io forum announcement

  - Update title of #magmelldollar on Freenode IRC
