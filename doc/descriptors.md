# Support for Output Descriptors in Magmelldollar Core

Since Magmelldollar Core v0.17, there is support for Output Descriptors in the
...
on Magmelldollar's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Magmelldollar Core wallets, a convenience function `combo` is
