...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/magmelldollar-project/magmelldollar/blob/0.13/src/chainparams.cpp#L214).
