...
1. Clone the magmelldollar source code and cd into `magmelldollar`
...
2.  Build magmelldollar-core:
    ...
    Configure and build the headless magmelldollar binaries as well as the GUI (if Qt is found).
...
------------------------
You can use Qt Creator as an IDE, for magmelldollar development.
...
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/magmelldollar/magmelldollar/issues/7714)
