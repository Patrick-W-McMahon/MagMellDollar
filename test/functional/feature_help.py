...
"""Verify that starting magmelldollar with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start magmelldollar with -h for help text")
        ...
        self.log.info("Start magmelldollar with -version for version information")
        ...
        self.log.info("Start magmelldollard with -fakearg to make sure it does not start")
