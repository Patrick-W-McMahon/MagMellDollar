...
unlocked to sign the Magmelldollar-Qt.app bundle.
...
allowing somebody to distribute a Magmelldollar-Qt.app or magmelldollar-qt-setup.exe with a valid
...
that the magmelldollar-qt.exe file inside the installer had not been tampered with.
