...
The Magmelldollar Core project operates an open contributor model where anyone is welcome to contribute towards development in the form of peer review, testing and patches. This document explains the practical process and guidelines for contributing.
...
The following applies to code changes to the Magmelldollar Core project (and related projects such as libsecp256k1), and is not to be confused with overall Magmelldollar Network Protocol consensus changes.

Whether a pull request is merged into Magmelldollar Core rests with the project merge maintainers and ultimately the project lead.
