// Copyright (c) 2015 The Magmelldollar Core developers
...
{
    RenameThread("magmelldollar-http");
...
{
    RenameThread("magmelldollar-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/magmelldollar/magmelldollar/pull/6990)
