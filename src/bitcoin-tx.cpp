...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " magmelldollar-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  magmelldollar-tx [options] <hex-tx> [commands]  Update hex-encoded magmelldollar transaction\n" +
            "or:     magmelldollar-tx [options] -create [commands]   Create hex-encoded magmelldollar transaction\n" +
            "\n";
