// Copyright (c) 2013-2015 The Magmelldollar Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CMagmelldollarAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CMagmelldollarAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CMagmelldollarAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CMagmelldollarAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CMagmelldollarAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CMagmelldollarAddress(arr[0].get_str()).Get() == demoAddress.Get());
