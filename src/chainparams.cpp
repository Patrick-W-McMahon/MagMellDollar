...
{
    const char* pszTimestamp = "Sic nos sic sacra tuemur";// Thus we guard our sacred rights.
...
public:
    CMainParams() {
        ...
        /*
        genesis = CreateGenesisBlock(1564340130, 2085654654, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        cout << consensus.hashGenesisBlock.ToString() << endl;
        cout << uint256S("0x04ffff001d010418536963206e6f7320736963207361637261207475656d7572").ToString() << endl;
        cout << "------------------------------" << endl;
        */
        genesis = CreateGenesisBlock(1564340130, 2086881112, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x519537cf1b9aa64216db0860396671051150685b579263ba42877f864f4fb773"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fabfdf42ba74dd6ddd9ad0ec4ad00fe0dcbe688d868468978d1e5b485674cc8"));
        ...
        //vSeeds.emplace_back("seed-a.magmelldollar.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.magmelldollartools.com");
        //vSeeds.emplace_back("dnsseed.magmelldollarpool.org");
        ...
        checkpointData = {
            {
                {0, uint256S("0x519537cf1b9aa64216db0860396671051150685b579263ba42877f864f4fb773")},
                /*
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1564340130, 4, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa18f008accdf9ff3fc819ab2f7f606a5367be04aec274bdf7876ea727abb7c0e"));
        assert(genesis.hashMerkleRoot == uint256S("0x4fabfdf42ba74dd6ddd9ad0ec4ad00fe0dcbe688d868468978d1e5b485674cc8"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("a18f008accdf9ff3fc819ab2f7f606a5367be04aec274bdf7876ea727abb7c0e")}
