...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.magmelldollar.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("magmelldollartools.com", "dnsseed.magmelldollartools.com"));
        vSeeds.push_back(CDNSSeedData("magmelldollarpool.org", "dnsseed.magmelldollarpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("magmelldollartools.com", "testnet-seed.magmelldollartools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.magmelldollar.loshan.co.uk", true));
