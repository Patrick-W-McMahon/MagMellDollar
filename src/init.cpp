 ...
 * between magmelldollard, and magmelldollar-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("magmelldollar-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/magmelldollar-project/magmelldollar>";
    const std::string URL_WEBSITE = "<https://magmelldollar.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("magmelldollar-loadblk");
    CImportingNow imp;
...
/** Sanity checks
 *  Ensure that Magmelldollar is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Magmelldollar version %s\n", FormatFullVersion());
}

/** Initialize magmelldollar.
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Magmelldollar process is using the data directory.
