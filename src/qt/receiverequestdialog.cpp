...
#include "config/magmelldollar-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMagmelldollarURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MagmelldollarUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMagmelldollarURI(info));
}
