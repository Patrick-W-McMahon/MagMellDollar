...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, MagmelldollarUnits::SeparatorStyle separators=MagmelldollarUnits::separatorStandard) const;
