...
void TestGUI()
{
    ...
    // Magmelldollar: Disable BumpFee tests
    ...
    QString balanceComparison = CurrencyUnits::formatWithUnit(unit, balance, false, CurrencyUnits::separatorAlways);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: magmelldollar:")) != -1);
