...
#define BOOST_TEST_MODULE Magmelldollar Test Suite

#include "test_magmelldollar.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_magmelldollar_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
