...
// Copyright (c) 2009-2012 The Magmelldollar Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Magmelldollar/$1-%s The Magmelldollar/' %s"
REGEX_CURRENT= re.compile("%s The Magmelldollar" % year)
